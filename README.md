...
This is a Web3 dApp frontend that demonstrates blockchain interaction patterns using modern tooling. It connects to the `FundMe` smart contract from the Foundry course, showcasing wallet integration, contract reading, and transaction handling through Viem's powerful abstractions.
...
The frontend demonstrates key Viem concepts including:

- WalletClient for managing user wallet connections and transactions
- PublicClient for reading blockchain state and contract data
- Simulate-then-write pattern for safe transaction execution
- MetaMask integration for wallet connectivity

The underlying smart contract can be found here:
...
```bash
git clone https://github.com/Molina-Daniel/html-ts-coffee-cu
